...
public class TwilioVoicePlugin extends CordovaPlugin {
    ...
    public void initialize(CordovaInterface cordova, CordovaWebView webView) {
        ...
        Log.d(TAG, "mIncomingCallIntent");
        } else if (intent != null && intent.getAction() != null && intent.getAction().equals(ACTION_CANCELLED_CALL)) {
            handleCancel();
    ...
    public boolean execute(final String action, final JSONArray args,
        ...
        if ("initializeWithAccessToken".equals(action)) {
          ...
          Log.d(TAG, "Initializing Permission");

          try {
            if(!PermissionHelper.hasPermission(this, Manifest.permission.RECORD_AUDIO)) {
              PermissionHelper.requestPermission(this, SAVE_TO_ALBUM_SEC, Manifest.permission.RECORD_AUDIO);
            }
          }
